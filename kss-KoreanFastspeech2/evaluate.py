    ...
    for i, batchs in enumerate(loader):
        for j, data_of_batch in enumerate(batchs):
            ...
            with torch.no_grad():
                ...
                print("Total Loss: {:.4f}, Mel Loss: {:.4f}, Mel PostNet Loss: {:.4f}, Duration Loss: {:.4f}, F0 Loss: {:.4f}, Energy Loss: {:.4f};".format(
                  total_loss.item(), mel_loss.item(), mel_postnet_loss.item(), d_loss.item(), f_loss.item(), e_loss.item()
                ))
