...
### kss ###
dataset = "kss"
#data_path = "/content/drive/MyDrive/AudioData_kss/kss-Korean-FastSpeech2-Pytorch/dataset_kss/kss"
data_path = '/content/drive/MyDrive/kss-Korean-FastSpeech2-Pytorch/dataset_kss/kss'
...
vocoder_pretrained_model_path = "/content/drive/MyDrive/kss-Korean-FastSpeech2-Pytorch/vocoder/pretrained_models/vocgan_kss_pretrained_model_epoch_4500 (1).pt"
